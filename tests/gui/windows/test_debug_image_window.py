...
from foxhole_stockpiles.gui.windows.debug_image_window import (
    DatabaseLoader,
    DebugImageWindow,
)
...
class TestDatabaseLoader:
    ...
    def test_run_success(self, qtbot: Any) -> None:
        ...
        with patch("foxhole_stockpiles.gui.windows.debug_image_window.TemplateManager"):
            with patch(
                "foxhole_stockpiles.gui.windows.debug_image_window.asyncio.run",
    ...
    def test_run_error(self, qtbot: Any) -> None:
        ...
        with patch(
            "foxhole_stockpiles.gui.windows.debug_image_window.TemplateManager",
...
class TestDebugImageWindowBrowse:
    ...
    def test_browse_cancelled(self, debug_window: DebugImageWindow) -> None:
        ...
        """
        with patch(
            "foxhole_stockpiles.gui.windows.debug_image_window.QFileDialog.getOpenFileName",
            return_value=("", ""),
        ):
...
class TestDebugImageWindowScan:
    ...
    def test_scan_without_database_path(self, debug_window: DebugImageWindow) -> None:
        ...
        with patch(
            "foxhole_stockpiles.gui.windows.debug_image_window.QMessageBox.warning"
        ) as mock_warning:
    ...
    def test_scan_clears_previous_results(self, debug_window: DebugImageWindow) -> None:
        ...
        with patch(
            "foxhole_stockpiles.gui.windows.debug_image_window.ImageScanWorker"
