...
def dialog(qtbot: Any) -> DatabaseBuilderSettingsDialog:
    ...
    """
    with patch("foxhole_stockpiles.gui.windows.database_builder_settings_dialog.get_settings"):
...
def test_load_settings_success(qtbot: Any) -> None:
    ...
    with patch(
        "foxhole_stockpiles.gui.windows.database_builder_settings_dialog.get_settings"
...
def test_save_and_accept_success(qtbot: Any) -> None:
    ...
    with patch(
        ...
        with patch(
            "foxhole_stockpiles.gui.windows.database_builder_settings_dialog.ConfigManager"
