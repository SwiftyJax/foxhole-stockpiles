...
from fs_tools.commands.candidate_inspector.candidate_inspector import main
...
class TestCandidateInspectorMain:
    ...
    @patch("fs_tools.commands.candidate_inspector.candidate_inspector.TemplateManager")
    @patch("fs_tools.commands.candidate_inspector.candidate_inspector.setup_logging")
    ...
    @patch("fs_tools.commands.candidate_inspector.candidate_inspector.TemplateManager")
    @patch("fs_tools.commands.candidate_inspector.candidate_inspector.setup_logging")
    @patch("fs_tools.commands.candidate_inspector.candidate_inspector.cv2.imread")
    ...
    @patch("argparse.ArgumentParser.parse_args")
    @patch("fs_tools.commands.candidate_inspector.candidate_inspector.get_settings")
...
def test_main_module_importable() -> None:
    ...
    import fs_tools.commands.candidate_inspector.__main__  # noqa: F401
