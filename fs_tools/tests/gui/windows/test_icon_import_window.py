...
def test_open_settings_dialog_accepted_and_configured(
    ...
    with patch(
        ...
        with (
            patch(
                "fs_tools.gui.windows.icon_import_window.DatabaseBuilderSettingsDialog"
            ) as mock_dialog_class,
            patch(
                "fs_tools.gui.windows.icon_import_window.reload_settings",
                return_value=mock_configured_settings,
            ),
            patch(
                "fs_tools.gui.windows.icon_import_window.get_settings",
...
def test_open_settings_dialog_rejected(qtbot: Any, mock_unconfigured_settings: AppSettings) -> None:
    ...
    with patch(
        ...
        with (
            ...
            patch("fs_tools.gui.windows.icon_import_window.reload_settings") as mock_reload,
        ):
            mock_dialog = MagicMock()
