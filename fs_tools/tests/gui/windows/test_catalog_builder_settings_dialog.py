...
def dialog(qtbot: Any) -> CatalogBuilderSettingsDialog:
    ...
    """
    with patch("fs_tools.gui.windows.catalog_builder_settings_dialog.get_settings"):
...
def test_load_settings_success(qtbot: Any) -> None:
    ...
    with patch(
        "fs_tools.gui.windows.catalog_builder_settings_dialog.get_settings"
...
def test_save_and_accept_success(qtbot: Any) -> None:
    ...
    with patch(
        ...
        with patch(
            "fs_tools.gui.windows.catalog_builder_settings_dialog.ConfigManager"
